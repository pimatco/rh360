...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/modificacao-principal.css">
	...
	<body>
	<div class="container">	
		<h1 id="titulo-principal"><font id="logo">RH</font> 360</h1>
	</div>
	<!--Carrocel-->
	<div class="container">
	...
	<!-- Header -->
				<div class="container">	
					...
					<div class="col-md-7">					
						<form action="cadastra_lead.php" method="post" id="formlead" class="form-inline">
